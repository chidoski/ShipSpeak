-- ShipSpeak Seed Data
-- Base scenario templates and system configuration
...
-- ============================================================================
-- DEFAULT USER PROGRESS ENTRIES
-- ============================================================================

-- This will be populated when users first practice in each skill area
-- The trigger function will create initial entries with foundation level